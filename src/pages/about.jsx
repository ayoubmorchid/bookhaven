        ...
        <section className="about-section">
          <div className="about-content">
            ...
            <div className="about-text">
              ...
              <p>
                Welcome to BookHaven, your ultimate destination for discovering inspiring stories, educational resources, and timeless classics. We aim to ignite a love for reading and provide access to books for every reader.
              </p>
              <p>
