      ...
      <section className="about-section">
        <div className="about-content">
          ...
          <div className="about-text">
            ...
            <p>
            Welcome to BookHaven, your ultimate destination for discovering inspiring stories, educational resources, and timeless classics. We aim to ignite a love for reading and provide access to books for every reader.</p>
            <p>
            Join us in our mission to build a world where knowledge and imagination are accessible to everyone, one book at a time.</p>
            <Link to="https://www.facebook.com/green.bag.206066" className="learn-more-btn">
              <FontAwesomeIcon  /> Learn More
            </Link>
          </div>
        </div>
      </section>
